...
?>
    ...
    <section class="container-fluid">
        ...
        <div class="mb-3">Репозиторий: <a href="https://github.com/SashaBitMake/OTUS-BITRIX">https://github.com/</a> указать URL своего репозитория</div>
        <ul class="item-list">
            <li>
                <h2 class="item done">
            ...
            <li>
                <h2 class="item done"><a href="homework7/">ДЗ #7: Создание кастомных полей и встраивание их в систему - в процессе</a>
                    <div class="icon"></div>
                </h2>
            </li>
            <li>
